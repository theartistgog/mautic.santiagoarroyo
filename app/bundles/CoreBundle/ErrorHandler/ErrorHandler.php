    ...
    class ErrorHandler
    {
        ...
        private function generateResponse($error, $inTemplate = false)
        {
            ...
            try {
                ...
                $loader             = new \Twig\Loader\FilesystemLoader([$baseDir.'/app/bundles/CoreBundle/Resources/views/Offline', $baseDir.'/app/bundles/CoreBundle/Resources/views/Exception']);
